...
public abstract class AbstractDeclClass extends Tree {
    ...
    /**
     * Génère la table de méthode de l'ensemble des classes du programme
     * à l'exception de la classe Object.
     */
    public abstract void codeGenClassTable(DecacCompiler compiler);
  
    /**
     * Génère le code assembleur de l'initialisation des champs
     * et des méthodes pour une classe.
     */
    public abstract void codeGenClass(DecacCompiler compiler);
  
    /**
     * count the numbre of SP
     * @return the numbre of SP
     */
